...
import 'package:store_app_proj/tools/credit_card_bloc.dart';
import 'package:store_app_proj/userScreens/payment_success.dart';
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            Navigator.push(_context,
                MaterialPageRoute(builder: (_context) => PaymentSuccessPage()));
            CartBloc _cartBloc = CartBloc();
            _cartBloc.removeAllOrder();
          },
